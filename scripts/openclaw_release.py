...
def build_parser() -> argparse.ArgumentParser:
    ...
    auto_playlist_parser.add_argument("--loop-video", default="", help="Optional 8 second visual loop clip generated by Dreamina/Seedance. The app repeats it during video render.")
