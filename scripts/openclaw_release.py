...
def build_parser() -> argparse.ArgumentParser:
    ...
    auto_playlist_parser.add_argument("--loop-video", default="", help="Optional 6 second visual loop clip generated by Dreamina/Seedance. The app repeats it during video render.")
    auto_playlist_parser.add_argument("--hard-loop-video", action="store_true", help="Use direct repeat instead of the default smooth 2 second forward crossfade loop render.")
    ...
    auto_single_parser.add_argument("--loop-video", default="", help="Optional 6 second visual loop clip generated by Dreamina/Seedance. The app repeats it during video render.")
    auto_single_parser.add_argument("--hard-loop-video", action="store_true", help="Use direct repeat instead of the default smooth 2 second forward crossfade loop render.")
    ...
    loop_video_parser.add_argument("--loop-video", required=True, help="Path to a 6 second loop video: mp4, mov, m4v, or webm.")
    ...
    loop_video_parser.add_argument("--hard-loop", action="store_true", help="Use direct repeat instead of the default smooth 2 second forward crossfade loop render.")
