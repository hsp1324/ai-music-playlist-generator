    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- For Cinematic Pulse, public titles should sound like cinematic orchestra, movie OST, film score, trailer, final battle scene, or epic scene music. Do not use juvenile game-menu wording such as 'Final Boss Focus Music', 'Final Boss Music', 'Boss BGM', '보스', or '보스전'. Prefer examples like '[playlist] Final Battle Scene Cinematic Music | Dark Fantasy Orchestra' or '[playlist] Cinematic Orchestra Music | Movie OST for Focus and Epic Scenes'.",
