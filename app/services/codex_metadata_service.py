    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- For Cinematic Pulse, public titles should sound like cinematic orchestra, movie OST, film score, trailer, final battle scene, or epic scene music. Do not use juvenile game-menu wording such as 'Final Boss Focus Music', 'Final Boss Music', 'Boss BGM', '보스', or '보스전'. Rotate among varied cinematic lanes such as final battle, dark fantasy, heroic trailer, emotional score, sci-fi action, mystery tension, grand journey, orchestral battle, writing music, and movie OST focus. Examples are style references, not fixed templates to repeat.",
