    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- Also write localized YouTube metadata for Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic suitable for Arabic/Egyptian audiences, Simplified Chinese, and Traditional Chinese in localizations. Use language keys exactly: ko, ja, en, es, vi, th, hi, fil, id, tr, pt-BR, pt-PT, fr, de, ar, zh-CN, zh-TW.",
                "- Localizations that are not the main language should be natural transcreations, not machine-looking literal copies.",
                "- For every localized title, write the strongest natural YouTube title for that language's audience. If literal translation is awkward, weak, too long, or less clickable, change the wording, order, or exact hook while keeping the release identity, genre/lane, and use case truthful.",
                ...
                "- For sundaze, English pop, American pop, US/UK pop, western pop, mainstream English pop, Pop R&B, pop-rock, country pop, Americana pop, indie pop, Afropop, or Amapiano-pop playlist releases, write the main metadata in English and keep lyrics/title language English-forward.",
                "- For sundaze, localized video titles may be natural adaptations in each language instead of exact English copies. Keep English song titles in localized timestamped tracklists, but make the video title locally clickable.",
                ...
                "- For playlist releases, put a real listening situation or viewer intent directly in the title, not only the description. Choose it from the release concept and actual audio energy; do not default to study/walk/work/rest wording by habit.",
                "- Across every channel, broad natural YouTube wording is more important than novelty. Reusing a strong channel-fit title shape is acceptable when it is mainstream and searchable; do not invent awkward niche phrases just to avoid repetition.",
                "- Across every channel and every localized title, never put Garage, UK Garage, UKG, 개러지, or a translated equivalent in the public title or thumbnail phrase. The underlying style may still use garage rhythm privately. Package it with a broader familiar label that truthfully fits, such as Dance Music, Club Mix, Bass Music, EDM, or another mainstream parent genre, and add another popular compatible style instead of leading with garage.",
                "- Before returning metadata, read the main title and every localized title as a normal viewer in that language. Reject titles that become awkward noun piles such as 'Gaming Night & Workout Energy', 'Night Roads, Gaming Focus and Club Drive', 'Bonus Stage Music' as the main hook, 'Final Boss Focus Music', 'Hope Energy', 'Prayer Focus Music', or literal equivalents in any language.",
                "- Use only one or two clear hooks after the separator. The title should sound like a real YouTube music video, mix, playlist, or OST release, not search keywords glued together.",
                "- Use walk/night walk only when walking, commuting on foot, street movement, beach/forest walks, crosswalks, or similar movement is central. For arcade/game-center/friends/night-out concepts, prefer arcade, gaming, friends, night out, getting ready, drive, weekend energy, or party warmup.",
                "- For Soft Hour Radio, lead with piano/solo piano plus useful BGM situations such as study, work, reading, sleep, rest, cafe, focus, or relaxation. Do not hide the piano identity behind generic BGM. Use natural clickable Korean/default wording such as '조용히 집중하고 싶을 때 듣는 피아노 BGM | 공부와 작업을 위한 솔로 피아노', '잠들기 전 틀어놓는 잔잔한 피아노 | 깊은 밤 휴식과 수면 BGM', or equivalent localized transcreations. Do not call Soft Hour lofi beats, guitar, jazz trio, Rhodes, strings, pads, or mixed-instrument BGM unless the human explicitly changed the channel direction. Do not make niche visual props or craft-room scene labels the main title hook unless the human explicitly asks.",
                "- For Club Bloom, title the release like a real EDM/house YouTube mix: put a mainstream public genre or lane right after '[playlist]' and use natural hooks such as 'Heavy EDM for Gaming & Night Drive', 'Running Beats and Club Bass', or 'Night Drive & Gaming Club Music'. If the private production lane is UK garage, title it as Dance Music, Club Mix, Bass Music, or EDM instead. Never write Garage, UK Garage, UKG, or abstract keyword tails such as 'Gaming Night & Workout Energy'.",
                "- For BGM playlists, the title should answer why someone would click now: studying, working, driving, reading, sleeping, resting, cafe ambience, relaxation, or another use case that actually matches the sound.",
                "- For Japan/J-pop/Tokyo Daydream Radio titles, do not over-emphasize the language. Prefer 'J-POP', the truthful lane such as Japanese hip-hop, J-rap, Tokyo R&B, city-pop, anime-pop, or synth-pop, mood, and listening use cases. Avoid Korean title phrases like '일본어 J-pop', '일본어 보컬', or '일본어 카페 재즈' unless the human explicitly asks to highlight the language. If language matters, mention it naturally in the description instead.",
                "- For HaruHaru, write Korean/default titles with a click-led hook shape: '[playlist] 짧은 감정/상황 훅 | 상황에 듣기 좋은 장르 노래모음'. Lead with a tasteful Korean line or question such as '나랑 데이트 할래?', '오늘 좀 예뻐 보이고 싶어', '전남친이 후회하게', or '너도 나 좋아하잖아', then name the real situation and genre. The hook must match the thumbnail/cover mood and must not be explicit, misleading, or unrelated to the music. Avoid language labels or raw scene labels such as 'Korean Pop', 'Seoul Music', or 'Practice Room Night Energy' unless the phrase is naturally clickable in Korean.",
                ...
                "- For Storylight OST, lead with the listener benefit or easy use case, then broad game/anime-BGM identity. Do not make internal game labels such as 'Bonus Stage Music', 'Item Shop BGM', or 'Quest Board' the main title hook unless explicitly requested.",
                "- For Cinematic Pulse, public titles should sound like cinematic orchestra, movie OST, film score, trailer, final battle scene, premium game orchestra, anime action-RPG OST, cinematic game score, gentle game orchestra, or sweet fantasy game score. Do not use juvenile game-menu wording such as 'Final Boss Focus Music', 'Final Boss Music', 'Boss BGM', '보스', or '보스전'. Rotate among varied cinematic lanes such as final battle, dark fantasy, heroic trailer, emotional score, sci-fi action, mystery tension, grand journey, orchestral battle, gentle game orchestra, lyrical fantasy RPG score, bittersweet anime action-RPG OST, soft/sweet game orchestra, writing music, and movie OST focus. Examples are style references, not fixed templates to repeat.",
                "- For BibliaCanto Bible releases, include the passage, Old/New Testament branch, theme, and selected release-level music lane. The whole release should stay in one coherent modern lane such as scripture hip-hop, Bible R&B, K-pop-inspired scripture pop, scripture rap-pop, trap-soul scripture songs, boom-bap Bible rap, alt-R&B scripture songs, neo-soul scripture songs, Afropop/Amapiano-pop scripture songs, dark street-pop scripture, or synth-pop scripture songs, so the title can truthfully name that genre. Never position BibliaCanto as Gospel music, worship, holy worship, church choir, hymns, praise band, CCM, congregational music, or prayer-ballad worship. Do not use generic Bible/worship labels, generic holy wording, or abstract keyword tails without scripture context.",
                "- For 불송 releases, use Korean default metadata and treat the Buddhist source/theme only as internal lyric inspiration and app metadata unless the human explicitly asks for a legacy/source-explicit public package. New default public titles, descriptions, tags, covers, thumbnails, and visible image text should avoid overt Buddhist vocabulary/source names such as 불교, 불경, 법구경, 금강경, 반야심경, 법화경, 부처, 자비, 가르침, 무상, 무아, 팔정도, 정어, other Eightfold Path terms, Dharma, Dhammapada, Heart Sutra, Diamond Sutra, or Buddhist. Use mainstream song-first Korean wording that names the real lane and a broad emotional/listening promise, such as 힙합, 랩, R&B, 소울, 트립합, 아트팝, or 노래. Korean/default titles should not waste title space on redundant language labels such as 한국어 랩 or 한국어 힙합. Do not relabel an already-rendered source-explicit or Dharma-pop 불송 video as a different lane if the audio or burned-in visual text says otherwise; keep metadata truthful to the finished video. Already-uploaded/source-explicit 불송 videos belong in the YouTube playlist 불송; new mainstream 불송 videos belong in 노래.",
                "- Good sundaze title examples: [playlist] Sunset Highway Pop Drive | Windows Down Road Trip Music; [playlist] Country Pop Road Trip | Highway Songs for Summer Nights; [playlist] Afropop Summer Nights | English Pop Dance Songs for Beach Drives.",
                ...
                "- For Japan/J-pop/Tokyo Daydream Radio releases, write localized timeline rows this way: Korean description = Japanese title plus Korean translation in parentheses, Japanese description = Japanese title only, and English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese descriptions = translated title text only.",
                ...
                "- For sundaze, English pop, American pop, US/UK pop, western pop, mainstream English pop, Pop R&B, pop-rock, country pop, Americana pop, indie pop, Afropop, or Amapiano-pop playlist releases, keep the English track title text in every localized timestamped tracklist row. Translate only the surrounding prose, use-case line, and hashtags.",
            ...
            "properties": {
                ...
                "localizations": {
                    ...
                    "properties": {
                        ...
                        "fil": {"$ref": "#/$defs/localizedMetadata"},
                        "id": {"$ref": "#/$defs/localizedMetadata"},
                        "tr": {"$ref": "#/$defs/localizedMetadata"},
                        "pt-BR": {"$ref": "#/$defs/localizedMetadata"},
                        "pt-PT": {"$ref": "#/$defs/localizedMetadata"},
                        "fr": {"$ref": "#/$defs/localizedMetadata"},
                        "de": {"$ref": "#/$defs/localizedMetadata"},
                        "ar": {"$ref": "#/$defs/localizedMetadata"},
