    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- Also write localized YouTube metadata for Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Brazilian Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese in localizations. Use language keys exactly: ko, ja, en, es, vi, th, hi, fil, id, pt-BR, fr, de, ar, zh-CN, zh-TW.",
