    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- For Soft Hour Radio, lead with useful BGM situations such as study, work, reading, sleep, rest, cafe, focus, or relaxation. Do not make niche visual props or craft-room scene labels the main title hook unless the human explicitly asks.",
