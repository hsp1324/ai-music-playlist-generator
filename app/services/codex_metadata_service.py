    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- Also write localized YouTube metadata for Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, and Simplified Chinese in localizations. Use language keys exactly: ko, ja, en, es, vi, th, hi, zh-CN.",
        ...
        return {
            ...
            "properties": {
                ...
                "localizations": {
                    "type": "object",
                    "additionalProperties": False,
                    "required": ["ko", "ja", "en", "es", "vi", "th", "hi", "zh-CN"],
                    "properties": {
