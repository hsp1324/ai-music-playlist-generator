    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- For sundaze, English pop, American pop, US/UK pop, western pop, or mainstream English pop releases, keep the English track title text in every localized timestamped tracklist row. Translate only the surrounding prose, use-case line, and hashtags.",
