    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- For Club Bloom, title the release like a real EDM/house YouTube mix: put the genre or lane right after '[playlist]' and use natural hooks such as 'Heavy EDM for Gaming & Night Drive', 'Running Beats and Club Bass', or 'Night Drive & Gaming Club Music'. Never write abstract keyword tails such as 'Gaming Night & Workout Energy'.",
