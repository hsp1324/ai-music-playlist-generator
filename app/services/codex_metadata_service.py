    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- Use only one or two clear hooks after the separator. The title should sound like a real YouTube music video, mix, playlist, OST, or worship release, not search keywords glued together.",
                ...
                "- For Soft Hour Radio, lead with useful BGM situations such as study, work, reading, sleep, rest, cafe, focus, or relaxation. Do not make niche visual props or craft-room scene labels the main title hook unless the human explicitly asks. If the release is lofi / lo-fi, say lofi naturally in the title, localized titles, and first description paragraph instead of reducing it to generic BGM.",
                ...
                "- For HaruHaru, write Korean K-pop titles that read like real Korean playlist copy. Avoid language labels or raw scene labels such as 'Korean Pop', 'Seoul Music', or 'Practice Room Night Energy' unless the phrase is naturally clickable in Korean.",
                ...
                "- For BibliaCanto Bible releases, include the passage, Old/New Testament branch, theme, and selected release-level music lane. The whole release should stay in one coherent lane such as scripture jazz, gospel R&B/soul, acoustic scripture folk/gospel, modern worship pop, piano worship ballads, choir-backed worship/gospel, cinematic scripture/Gospel worship, or neo-soul prayer songs, so the title can truthfully name that genre. Do not use generic Bible/worship labels, generic holy wording, or abstract keyword tails without scripture context.",
                "- For 불송 Buddhist releases, use Korean default metadata, include the Buddhist source or theme, and name one coherent lane such as Buddhist jazz, mindful hip-hop, Buddhist R&B/soul, dharma neo-soul, acoustic dharma songs, or cinematic meditation pop. State that lyrics are original paraphrases inspired by Buddhist teaching, not direct scripture recitation.",
