    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- For The Old Verse and The New Verse, include the passage, theme, and broad music style. Do not use generic Bible/worship labels or abstract keyword tails without scripture context.",
