    ...
    def _build_prompt(self, playlist: Playlist, tracks: list[Track], *, default_language: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "- Also write localized YouTube metadata for Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Simplified Chinese, and Traditional Chinese in localizations. Use language keys exactly: ko, ja, en, es, vi, th, hi, fil, zh-CN, zh-TW.",
                ...
                "- For Japan/J-pop/Tokyo Daydream Radio releases, write localized timeline rows this way: Korean description = Japanese title plus Korean translation in parentheses, Japanese description = Japanese title only, and English, Spanish, Vietnamese, Thai, Hindi, Filipino, Simplified Chinese, and Traditional Chinese descriptions = translated title text only.",
        ...
        return {
            ...
            "properties": {
                ...
                "localizations": {
                    "type": "object",
                    "additionalProperties": False,
                    "required": ["ko", "ja", "en", "es", "vi", "th", "hi", "fil", "zh-CN", "zh-TW"],
                    "properties": {
