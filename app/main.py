...
from app.routes import health, openclaw, playlists, render_worker, slack, suno, tracks, ui, youtube
...
def create_app() -> FastAPI:
    ...
    app.include_router(openclaw.router, prefix=settings.api_prefix)
