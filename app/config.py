...
class Settings(BaseSettings):
    ...
    video_lyrics_overlay_serif_font: str = "Noto Serif KR"
    ...
    playlist_target_minutes: int = 10
    ...
    playlist_final_video_max_repeat_count: int = 12
    ...
    render_worker_claim_disk_safety_margin_percent: float = 0.0
