...
- Normal automated Playlist Releases target 40 minutes. When audio render is queued, the app can automatically reuse previous same-channel, similar-genre tracks from the back half of already uploaded YouTube releases to fill the remaining time; if no suitable reuse candidates exist, rendering continues with the uploaded new tracks.
