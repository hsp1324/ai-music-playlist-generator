...
- Normal automation renders video on the Oracle VM app background worker. `scripts/render-worker` remains an optional/manual escape hatch for extra machines, but OpenClaw should not rely on laptop render workers in the default flow.
