...
- The next-release loop is planned by `docs/openclaw-next-release-planner.md`: it rotates active channels, avoids recent concept repetition, and then hands off to the automatic private playlist publisher.
