...
- Listening use cases must fit the actual rendered music. Do not force generic focus/study/work wording onto energetic pop, rooftop, club, dance-pop, bass-heavy, or workout-ready releases. For that energy, prefer use cases such as getting ready, workout, running, party warmup, driving, nightlife, confidence, or weekend energy.
