...
- Never trim, crop, export a preview, or fade out a generated song just to make it fit a target duration. Upload the full finished Suno output. If a track sounds like it abruptly disappears around 3:00, treat that as a bad generation/export and regenerate or extend it before upload.
