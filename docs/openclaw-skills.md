...
- All static images and Dreamina/Seedance/Gemini loop clips must look animated, anime, illustrated, or stylized unless the selected channel profile says otherwise. Cinematic Pulse is the explicit exception: use original photorealistic cinematic film-still / premium movie-poster realism for cover, thumbnail base, and loop video.
