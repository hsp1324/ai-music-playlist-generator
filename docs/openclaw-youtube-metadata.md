...
For 불송 Buddhist scripture-inspired releases, write the main title/description in Korean, use `--default-language ko`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions. Include the selected Buddhist source or theme, such as Dhammapada-inspired, Heart Sutra-inspired, Diamond Sutra-inspired, Lotus Sutra-inspired, or Buddhist wisdom-inspired. By default, name one coherent Buddhist hip-hop/rap lane such as 불교 힙합, 불경 힙합, mindful hip-hop, Korean Buddhist rap, mellow boom bap, Buddhist hip-hop soul, or restrained Buddhist trap-soul. Use a non-hip-hop Buddhist lane only when the human explicitly asks or when finishing an already-started release in that lane. Do not relabel an already-rendered non-hip-hop 불송 video as hip-hop only to match the new default; if the audio and burned-in visual text already say Dharma pop, 다르마팝, acoustic Dharma songs, or 다르마송, keep the public metadata truthful to that finished video. State that lyrics are original paraphrases inspired by Buddhist teaching, not direct scripture recitation. The app schedules 불송 uploads public daily at 07:00 Asia/Seoul.
