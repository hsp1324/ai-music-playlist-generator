...
Good `Storylight OST` examples: `[playlist] Cute Arcade Game OST | Playful Japanese BGM for Gaming and Focus`; `[playlist] Fantasy RPG Town Music | Light Anime Game BGM for Reading and Play`; `[playlist] Kawaii Item Shop BGM | Cute Game OST for Work and Cozy Focus`.
