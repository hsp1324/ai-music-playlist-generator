...
- Global public-title rule: never put `garage`, `UK garage`, `UKG`, `개러지`, or a translated/localized equivalent in any new main title, localized title, thumbnail phrase, cover text, or first-frame text on any channel. Garage may remain an internal Suno/style/catalog label when it accurately describes the audio. Publicly package that sound with a broader familiar parent label such as `Dance Music`, `Club Mix`, `Bass Music`, `EDM`, or another truthful mainstream genre, and prefer adding a more recognizable compatible style rather than foregrounding garage. This rule applies to playlist and single releases.
...
- For playlist/BGM titles, include a clear listening situation in the title itself, not only in the description. Choose the situation from the actual concept and sound; do not repeat `study`, `work`, `walk`, or `rest` as defaults. During the trial period, normal automated playlists render the base block only; do not add awkward duration badges. Good Korean BGM patterns when they genuinely fit: `공부할 때 듣기 좋은 숲길 BGM`, `산책·드라이브할 때 듣기 좋은 해변 BGM`, `작업할 때 틀어놓기 좋은 카페 피아노`.
- For `Soft Hour Radio`, every title must clearly signal piano/solo piano and a real use case. Prefer natural clickable wording such as `조용히 집중하고 싶을 때 듣는 피아노 BGM | 공부와 작업을 위한 솔로 피아노`, `잠들기 전 틀어놓는 잔잔한 피아노 | 깊은 밤 휴식과 수면 BGM`, or `비 오는 밤 책 읽을 때 좋은 피아노 연주곡 | 독서와 휴식 BGM`. Do not publish Soft Hour metadata as generic BGM, lofi beats, guitar, jazz, Rhodes, strings, pads, or mixed-instrument music unless the human explicitly changes the channel direction.
...
- For `Storylight OST`, `Cinematic Pulse`, `Club Bloom`, and `BibliaCanto`, use English as the main/default metadata language with `--default-language en`. For Buddhist `불송`, use Korean as the main/default metadata language with `--default-language ko`.
- Keep the exact same timestamps and playback order in Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese descriptions. YouTube supports Egyptian-facing Arabic through the `ar` localization; it does not expose a separate `ar-EG` code.
...
- Before approving metadata, do a packaging check against [openclaw-channel-market-analysis.md](openclaw-channel-market-analysis.md), including its local performance feedback. The title, first description paragraph, thumbnail text, and cover/thumbnail scene must work together as one click promise. If the release repeats a recently weak pattern for that channel, such as interchangeable quiet-room piano BGM, generic happy game BGM, generic Bible landscape, statue-only Buddhist art, or raw genre keywords with no human/emotional hook, rewrite the title and regenerate or replace the thumbnail before approval.
...
Before writing final metadata, read docs/openclaw-channel-market-analysis.md and apply its selected-channel section plus local performance feedback. Treat the YouTube title and thumbnail as one package. Reject packaging that repeats locally weak patterns: interchangeable calm-room piano BGM, generic `Happy Game BGM`, generic Bible landscape, statue-only Buddhist imagery, raw genre labels without a human/emotional reason to click, or a thumbnail that does not make the music lane obvious in one glance.
...
Never use `garage`, `UK garage`, `UKG`, `개러지`, or a translated equivalent in the main title, any localized title, thumbnail phrase, cover text, or first-frame text on any channel. If the audio privately uses a garage style, use a truthful mainstream parent label such as `Dance Music`, `Club Mix`, `Bass Music`, or `EDM` and emphasize a more recognizable compatible style.
Reject titles in any language that become awkward noun piles, such as `game night and workout energy`, `night roads, gaming focus and club drive`, `bonus stage music` as the main hook, `final boss focus music`, or literal equivalents in that language. The title should sound like a natural music video, mix, playlist, or OST release, not like search keywords glued together.
...
For Japan/J-pop/Tokyo Daydream Radio releases, write Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese descriptions. In the Korean/default tracklist, use Japanese title plus Korean translation in parentheses. In the Japanese tracklist, use Japanese title only. In the English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese tracklists, translate only the displayed title text and keep timestamps fixed.
For sundaze English/American pop playlist releases, write the main title/description in English, use `--default-language en`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions. Localized video titles should be natural, click-oriented titles in each language rather than exact copies of the English title when the English wording would not click locally. In every localized timestamped tracklist, keep the track title text in English exactly as in the English description; translate only the surrounding prose, use-case line, and hashtag line.
For Solwave Radio Latin/Spanish pop releases, write the main title/description in Spanish, use `--default-language es`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions.
For HaruHaru K-pop releases, write the main title/description in Korean, use `--default-language ko`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions. The Korean/default title should be click-led but not formula-led. Compare against recent HaruHaru titles and reject repeated hook families, repeated situations, or repeated skeletons like `[hook] | [situation] 듣기 좋은 [genre] 노래모음`. Rotate between dialogue-hook-first, genre/use-case-first, immediate-payoff-first, mini-story-first, mood-identity-first, and searchable-lane-first titles. Keep the title truthful to the actual lane and keep the thumbnail scene consistent with the hook.
For Storylight OST playful no-vocal Japanese-style game/anime OST, arcade-game BGM, fantasy-game BGM, cute RPG music, item-shop music, and mini-game BGM releases, write the main title/description in English, use `--default-language en`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions. Storylight titles must lead with a listener benefit or easy use case such as happy mood, mood boost, gaming, work, reading, relaxing, cozy focus, or light focus, then name the broad game/anime-BGM identity. Do not make narrow internal game-scene labels such as `Bonus Stage Music`, `Item Shop BGM`, `Quest Board`, `Inventory Screen`, or `Potion Counter` the main title hook; keep those details in the description or tracklist. If the title would translate as a game menu label instead of a reason to click, rewrite it.
For Cinematic Pulse no-vocal large-scale cinematic orchestra, movie OST, film score, trailer, battle, emotional, mystery tension, and game-combat BGM releases, write the main title/description in English, use `--default-language en`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions. Titles must sound like film-score/cinematic-orchestra packaging for broad viewers; avoid juvenile game-menu phrases and abstract focus labels.
For Club Bloom no-vocal EDM/house/techno/trance releases, write the main title/description in English, use `--default-language en`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions. The title and description must describe the selected club sound as instrumental/no-vocal club music. Put a mainstream genre or genre fusion immediately after `[playlist]`, such as `Progressive Trance x EDM Mix`, `Tech House Workout Mix`, `Hype Trap x EDM Mix`, `Melodic Techno Night Drive`, `Bass House Workout Mix`, or `Festival EDM Mix`; put only one or two public use cases after the separator. A private UK-garage production lane must be titled as broader `Dance Music`, `Club Mix`, `Bass Music`, or `EDM`, never as Garage/UK Garage/UKG. Do not write abstract keyword endings such as `Gaming Night & Workout Energy`; use natural title promises such as `Heavy EDM for Gaming & Night Drive`, `Running Beats and Club Bass`, or `Night Drive & Gaming Club Music`.
For BibliaCanto Bible scripture-inspired releases, write the main title/description in English, use `--default-language en`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions. Both Old Testament and New Testament branches upload here. Include the passage reference in the main title, every localized title, and the description, and state whether it is Old Testament or New Testament. Use original paraphrase, not long copied Bible text. The first description paragraph must state the selected passage and adapted theme, such as creation, covenant, wilderness trust, lament, deliverance, wisdom, prophetic hope, grace, mercy, discipleship, healing, resurrection hope, or kingdom teaching. The description must also include one natural sentence naming the broad modern music style family, such as scripture hip-hop, Bible R&B, K-pop-inspired scripture pop, scripture rap-pop, trap-soul scripture songs, boom-bap Bible rap, alt-R&B scripture songs, neo-soul scripture songs, Afropop/Amapiano-pop scripture songs, dark street-pop scripture, or synth-pop scripture songs. Never position BibliaCanto as Gospel music, worship, holy worship, church choir, hymns, praise band, CCM, congregational music, or prayer-ballad worship. Do not use vague worship keyword tails like `Hope Energy`, `Prayer Focus Music`, `Bible Music`, or `Worship Music` with no passage/theme/style.
For 불송 releases, write the main title/description in Korean, use `--default-language ko`, and provide Korean, Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized versions. Keep the selected Buddhist source/theme in planning and app metadata, but new default public titles/descriptions/tags should avoid overt Buddhist vocabulary and source names. Use mainstream song-first wording that still matches the actual lane, such as 힙합, 랩, R&B, 소울, 트립합, 아트팝, or 노래 plus a real emotional/listening promise. Do not put words such as 불교, 불경, 법구경, 금강경, 반야심경, 법화경, 부처, 자비, 가르침, 무상, 무아, or 팔정도 in new public metadata unless the human explicitly asks for a legacy/source-explicit release. Do not relabel an already-rendered source-explicit or Dharma-pop 불송 video as a different lane if the audio or burned-in visual text says otherwise; keep metadata truthful to the finished video. The app schedules 불송 uploads public daily at 07:00 Asia/Seoul. Already-uploaded/source-explicit 불송 videos belong in the YouTube playlist `불송`; new mainstream 불송 videos belong in `노래`.
...
For `HaruHaru`, do not lead with neutral genre-first title shapes by default. Use the Korean clickable-hook shape first, then the situation and genre after the separator. For `sundaze`, `Solwave Radio`, `Storylight OST`, `Cinematic Pulse`, `Club Bloom`, `BibliaCanto`, and `불송`, titles should read like curated editorial or `Essential` playlists: vivid situation/emotion + genre identity + listening use case. Do not use raw workspace names, short generic labels, or translated noun chains such as `Golden Hour Drive Pop`, `Ruta Dorada Pop`, `English Pop`, `Spanish Pop`, `Latin Pop`, `KPOP`, `Korean Pop`, `Fantasy OST`, `Battle Music`, `EDM`, `Bible Music`, `Worship Music`, `Gaming Night & Workout Energy`, or `Focus and Club Drive` by themselves. It is better to reuse a strong public-facing title pattern than to make a technically unique title that sounds obscure, awkward, or too minor for YouTube discovery.
Good `sundaze` examples: `[playlist] Sunset Highway Pop Drive | Windows Down Road Trip Music`; `[playlist] Country Pop Road Trip | Highway Songs for Summer Nights`; `[playlist] Afropop Summer Nights | English Pop Dance Songs for Beach Drives`.
...
Good `HaruHaru` examples, as rotating shape references rather than fixed templates: `[playlist] 오늘 연락하지 마 | 혼자 나갈 때 켜는 다크 K-POP 트랩`; `[playlist] 붐뱁 K-POP으로 걷는 밤 | 홍대 골목에서 듣는 랩팝 믹스`; `[playlist] 첫 곡부터 고개 까딱이는 K-힙합 | 약속 전 텐션 올리는 음악`; `[playlist] 안 꾸민 척 나가는 밤 | 친구가 찍어준 듯한 Seoul R&B`; `[playlist] 차갑게 예쁜 밤공기 | 도도하게 걷는 Korean R&B`.
...
Good `불송` examples: `[playlist] 오늘은 조금 가벼워져 | 흔들리는 밤에 듣는 힙합 노래`; `[playlist] 말이 날카로워질 때 | 마음을 식혀주는 R&B 노래`; `[playlist] 잡고 있던 걸 놓는 밤 | 혼자 걷기 좋은 트립합`.
...
End the description with one public hashtag line containing 5-8 relevant hashtags. Also include equivalent hashtag lines in Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese localized descriptions.
Never use AI/process/tool hashtags or YouTube tags on any channel. Do not write `AIMusic`, `AI music`, `AI generated`, `AI visualizer`, `Suno`, `OpenClaw`, or `Codex` as tags or public hashtags.
...
Localized metadata:
- Also write Japanese, English, Spanish, Vietnamese, Thai, Hindi, Filipino, Indonesian, Turkish, Brazilian Portuguese, European Portuguese, French, German, Arabic, Simplified Chinese, and Traditional Chinese title/description files.
...
- If the selected channel is Storylight OST, Cinematic Pulse, Club Bloom, or BibliaCanto, make the English file the default top-level title/description and approve with `--default-language en`. If the selected channel is Buddhist 불송, make the Korean file the default top-level title/description and approve with `--default-language ko`.
- Use `--ko-title`, `--ko-description-file`, `--ja-title`, `--ja-description-file`, `--en-title`, `--en-description-file`, `--es-title`, `--es-description-file`, `--vi-title`, `--vi-description-file`, `--th-title`, `--th-description-file`, `--hi-title`, `--hi-description-file`, `--fil-title`, `--fil-description-file`, `--id-title`, `--id-description-file`, `--tr-title`, `--tr-description-file`, `--pt-title`, `--pt-description-file`, `--pt-pt-title`, `--pt-pt-description-file`, `--fr-title`, `--fr-description-file`, `--de-title`, `--de-description-file`, `--ar-title`, `--ar-description-file`, `--zh-title`, `--zh-description-file`, `--zh-tw-title`, and `--zh-tw-description-file` when approving metadata.
...
scripts/openclaw-release approve-metadata \
  ...
  --title "[playlist] 조용한 카페 피아노 솔로 | 공부, 작업, 휴식할 때 듣기 좋은 잔잔한 음악" \
