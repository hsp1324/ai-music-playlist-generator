...
- Do not put duration caps or lower-bound duration phrases such as `less than 4 minutes`, `under 4 minutes`, `at least 2 minutes`, `minimum 2 minutes`, or `2 minutes or longer` into Suno prompts, style fields, lyrics, or bracketed metatags unless the human explicitly asks for that wording. Those phrases can make Suno end too early or behave unpredictably. Ask structurally for an around 4 minute full-length complete song/cue, with a natural intro, developed middle, and resolved ending instead. Still verify the downloaded duration because Suno has no guaranteed minimum-duration field.
...
- Do not put duration caps or lower-bound duration phrases such as `less than 4 minutes`, `under 4 minutes`, `at least 2 minutes`, `minimum 2 minutes`, or `2 minutes or longer` into Suno prompts, style strings, lyrics, or bracketed metatags unless the human explicitly asks for that wording. Ask structurally for an around 4 minute full-length complete song/cue with natural section development, but verify the downloaded duration because Suno has no guaranteed minimum-duration field. Playlist tracks from 1:00 to 1:59 should be uploaded/used when they fit the release; only stop and report tracks under 1:00 unless the channel-specific workflow says otherwise. Complete 5+ minute tracks are allowed on every channel.
