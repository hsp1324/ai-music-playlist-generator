...
- For `불송`, use the Buddhist profile for Buddhist scripture-inspired modern vocal music. Korean lyrics are the default, and uploads should remain private until the human reviews the new channel direction.
...
- For `불송`, use thumbnail wording such as `BUDDHIST JAZZ`, `DHARMA R&B`, `MINDFUL HIP-HOP`, `SUTRA SONGS`, `불경 노래`, `법구경 힙합`, or `반야심경 R&B`, with smaller `불송` branding.
...
- Use `불송` for Buddhist scripture-inspired vocal music, Dhammapada/법구경-inspired songs, Heart Sutra/반야심경-inspired songs, Buddhist jazz, Buddhist hip-hop, Buddhist R&B/soul, dharma songs, mindfulness songs, and modern sutra-inspired music. Keep these uploads private for now.
