...
- If the human explicitly names the upload channel, that channel controls visual routing. `Soft Hour Radio에 올려줘` means use the Soft Hour calm atmospheric visual skill even if genre words such as Japan, J-pop, or city-pop appear elsewhere, unless the human separately asks for the Tokyo three-person walking visual.
