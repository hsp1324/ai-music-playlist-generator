...
For higher-level OpenClaw skill instructions, including "make one single", "build a playlist with roughly 20 minutes of new audio on normal channels before app-side reuse and roughly 40 minutes on scripture/Buddhist channels", and "write YouTube metadata", see [openclaw-skills.md](openclaw-skills.md).
