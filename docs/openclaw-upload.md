...
- Do not put duration caps or two-minute lower-bound wording into Suno prompts, style fields, lyrics, or bracketed metatags unless the human explicitly asks for that exact wording. Suno can misread those phrases and end too early. Ask for an around 4 minute full-length complete song/cue with a natural intro, developed middle, and resolved ending instead. Verify the downloaded duration.
...
- Do not put duration caps or two-minute lower-bound wording into Suno prompts, style strings, lyrics, or bracketed metatags unless the human explicitly asks for that exact wording. Ask for an around 4 minute full-length complete song/cue with developed structure, then verify the downloaded duration. The helper rejects playlist tracks shorter than 1:00 by default, records playlist tracks under 2:00 for later analysis, and has no default maximum duration. Complete 5+ minute tracks are allowed on every channel.
