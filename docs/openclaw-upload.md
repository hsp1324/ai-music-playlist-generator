...
- For `불송` vocal Suno work, always audition the downloaded candidate before uploading or approving it. Check the first verse/hook or at least the first 60-90 seconds and confirm clear Korean human rap/singing is present. If lyrics were supplied but the generated audio has no audible lead voice, is effectively instrumental, or only contains pads/hums, reject/regenerate it. Do not upload, approve, reuse, or fill a playlist with that failed vocal candidate.
