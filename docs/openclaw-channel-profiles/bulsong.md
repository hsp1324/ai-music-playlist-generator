...
- Voice-tone cues are required guidance, but they are not proof that Suno actually sang the lyrics. After downloading each 불송 candidate, audibly check the first verse/hook or at least the first 60-90 seconds before upload/approval. A usable 불송 vocal track must contain clear Korean human rap or singing that matches the supplied lyrics. If the audio is instrumental, pad-only, hum-only, missing a lead voice, or has no audible Korean human vocal even though lyrics were supplied, reject/regenerate it and do not upload, approve, reuse, or backfill it.
