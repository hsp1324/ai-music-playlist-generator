...
- Buddhist scripture-inspired Korean vocal music.
- Cover, thumbnail, and still-image render source should be one clean text-free Buddhist music visual package, but the package must vary aggressively across releases. Rotate photorealistic street-Buddhist scenes, temple-stay candid shots, surreal/metaphysical symbolism, cubist-inspired collage, new-age lotus abstraction, cyber-Buddhist neon, anime/illustrated Buddhist fantasy, dark editorial fashion, object-led album art, or other fresh lanes.
...
- Every new 불송 plan should include a `novelty_brief` explaining why the selected music lane and visual lane do not repeat recent uploads. Avoid repeating the same face/body type, prayer pose, Buddha close-up, outfit, camera angle, warm-gold temple palette, or old sutra-desk template.
