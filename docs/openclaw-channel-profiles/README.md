...
- Korean vocal music internally inspired by Buddhist sources, but public packaging should look and read like mainstream Korean songs.
- Cover, thumbnail, and still-image render source should be one clean text-free non-Buddhist mainstream song visual package. Do not show Buddhist/source cues by default: no Buddha statue/face, temple, monk, prayer pose, lotus, mandala, sutra pages, prayer beads, Dharma wheel, incense, shrine, or scripture text unless the human explicitly asks for source-explicit packaging.
- New 불송 releases are diversity-first. Hip-hop remains valid, but OpenClaw should also rotate into R&B, trip-hop, glitch-hop, drum and bass, hyperpop, art-pop, psychedelic soul, avant-jazz rap, spoken-word rap, new-age electronica, cinematic trap, and other coherent modern lanes when they fit the internal source/theme. Keep passage/theme/genre phrases such as `삼도 힙합`, `법구경`, `법구경 힙합`, `불경 힙합`, `마음챙김 랩`, `자비 힙합`, `팔정도 명상팝`, `정어 랩`, or `반야심경 랩` out of new public metadata and visual text unless the human explicitly asks for source-explicit wording in the current request. Never use `불송` as visual text, and avoid obscure coined genre labels.
- Every new 불송 plan should include a `novelty_brief` explaining why the selected music lane and visual lane do not repeat recent uploads. Avoid repeating the same face/body type, prayer pose, Buddha close-up, outfit, camera angle, warm-gold temple palette, old sutra-desk template, or any visible Buddhist motif.
...
- Visuals should use mainstream music/lifestyle cues instead: friend-taken adult Korean street scenes, R&B city nights, rainy room/car windows, stylish adult portraits, duet/couple tension, object-led album art, cinematic city stills, surreal nonreligious symbols, or bold graphic album-cover realism. Avoid stale religious wallpaper, generic old sutra-desk scenes, temple/lotus/lantern imagery, and visible Buddhist objects.
