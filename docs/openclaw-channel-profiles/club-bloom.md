...
- Do not add subtitles, lyrics, title text, duration text, UI, logos, explicit nudity, unsafe minors, protected brands, or real club footage.
...
Stable composition, no hard cuts, no photorealism, no live action, no explicit nudity, no unsafe minors, no protected brands, no other text, no subtitles, no logos, no UI.
```
