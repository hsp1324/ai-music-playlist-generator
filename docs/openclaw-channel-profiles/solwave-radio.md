...
- Backfill/reuse must match the detailed lane, not just broad Latin/Spanish pop. For example, reggaeton releases need reggaeton/urbano backfill, bachata releases need bachata backfill, salsa releases need salsa backfill, cumbia releases need cumbia backfill, and Latin R&B releases need R&B/neo-soul backfill. If the matching pool is exhausted, generate more same-lane Suno songs under [openclaw-one-hour-new-audio-policy.md](../openclaw-one-hour-new-audio-policy.md); never fill the hour with unrelated Latin pop.
