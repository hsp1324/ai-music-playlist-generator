...
- OpenClaw machine: creates workspaces, generates/uploads audio, cover, thumbnail, and required visual source. Moving-video channels use a short loop video; HaruHaru, sundaze, and Solwave Radio use a still-image render source.
