...
- Loop-video upload validates only that the file is readable video and close to 10 seconds long. The app does not reject low-motion clips; visual quality is handled by human/OpenClaw review before render/publish.
