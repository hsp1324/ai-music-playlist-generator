...
- For 불송 and other vocal Suno work, voice/timbre cues are required but are not enough by themselves. OpenClaw must audition downloaded candidates before upload/approval and reject/regenerate any lyric-bearing result with no clear human lead vocal. Failed no-vocal outputs from vocal releases should be marked disliked/reuse-disabled rather than reused as filler.
