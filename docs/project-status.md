...
- `Tokyo Daydream Radio` thumbnails should use the approved consistent channel layout: large `J-POP` and smaller `TOKYO DAYDREAM RADIO` beneath it, using the same full-bleed system for Tokyo/city and forest/nature variants.
