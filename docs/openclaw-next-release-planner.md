...
For `불송`, the female-led visual rule is only for cover/thumbnail/still-image assets. Audio may use male lead vocals, male duet, male/female duet, female lead vocals, or mixed vocals. Every track should name a concrete vocal tone/delivery in the Suno style string so the voices do not collapse into the same default timbre.
