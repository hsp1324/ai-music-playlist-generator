...
- Use either photorealistic cinematic film-still / premium movie-poster realism or premium game-animation/anime-real key art when the concept is game orchestra, anime action-RPG, sci-fi heroine, or fantasy game score. Use cinematic lighting, depth of field, atmospheric haze, believable materials, and strong high-contrast composition.
- The premium game-animation lane may use an original beautiful adult heroine in elegant sci-fi/fantasy action-RPG styling, but do not copy Stellar Blade or any protected game character, costume, logo, UI, or exact pose/composition.
- Do not use flat cartoon, cheap anime, game UI art, documentary footage, real war footage, real flags, political symbols, celebrity likenesses, protected IP, or exact franchise references.
