...
- The first roughly 15 minutes of every new Soft Hour playlist should be newly generated solo piano tracks. Use `solo piano`, `felt piano`, `upright piano`, `quiet piano`, or `calm piano` directly in every Suno style/settings field.
