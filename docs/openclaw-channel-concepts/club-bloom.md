...
Use this after the selected channel is `Club Bloom`. This document decides the next playlist concept. Use `../openclaw-channel-profiles/club-bloom.md` afterward for cover, thumbnail, and short loop-video production rules.
