...
- Keep the channel identity stable. Do not borrow the fixed visual signature or genre rules from Tokyo Daydream Radio, Soft Hour Radio, HaruHaru, Midnight Cue Radio, sundaze, or Solwave Radio unless the channel title or human instruction clearly matches that identity.
