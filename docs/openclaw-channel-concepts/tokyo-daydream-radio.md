...
- Backfill/reuse must match the detailed Tokyo lane, not just broad J-pop. For example, Japanese R&B releases need R&B/neo-soul backfill, J-rap/Japanese hip-hop releases need hip-hop/rap/boom-bap/trap backfill, city-pop releases need city-pop backfill, anime-pop releases need anime-pop backfill, and pop-rock releases need pop-rock backfill. If the matching pool is exhausted, stop around the publishable 40 minute range instead of filling the hour with unrelated J-pop.
