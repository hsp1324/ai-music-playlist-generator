...
- The same scene, such as golden hour drive, Sunday park, summer road trip, night drive, beach, gym, rooftop, party, or heartbreak.
- The same pop substyle, such as dance-pop, synth-pop, guitar pop, pop-rock, chill pop, or emotional ballad.
- The same lyric premise, such as windows down, moving on, first love, weekend freedom, last text, confidence, or escape.
- The same short generic title shape.
- The same thumbnail text, such as `POP HITS`, `SUMMER POP`, `NIGHT DRIVE`, or `FEEL GOOD POP`.

If the latest sundaze title could be summarized by the same two nouns as the new idea, choose a different concept.
